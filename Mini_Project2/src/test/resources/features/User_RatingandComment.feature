Feature: Posts
  ...
  Scenario: GET - As an admin I have be able to see commant posts number 1
    Given I set GET commant api endpoints
    When I send GET commant HTTP request
    Then I receive valid HTTP response code 200


  Scenario: GET - As an admin I shouldn't be able to see commant posts with invalid url
